    ...
    public class Singleton<T> : MonoBehaviour where T : MonoBehaviour
    {
        ...
        public static T Instance
        {
            get
            {
                ...
                {
                    Debug.LogError(type +
                                   "class does not have SingletonAttribute ! Please add SingletonAttribute for " +
                                   type);
                    return null;
                }
                ...
                if (prefab == null)
                {
                    Debug.LogError("Cannot find prefab of " + type + "! Put prefab of" + type +
